...
<body>
	...
	<br>
	<div align="center">
		<a href="""${pageContext.request.contextPath}/samsung">Samsung</a>
			 <br /> <a href="""${pageContext.request.contextPath}/vivo">Vivo</a>
			 <br /> <a href="""${pageContext.request.contextPath}/onePlus">OnePlus </a>
			  <br /> <a href="""${pageContext.request.contextPath}/iPhone">IPhone</a>
			 <br /> <a href="""${pageContext.request.contextPath}/nokia">Nokia</a>
