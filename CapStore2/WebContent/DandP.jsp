	...
	<div class="header-container">
        ...
        Hello Japan  &nbsp;|&nbsp;
           <a href="${pageContext.request.contextPath}/logout">Logout</a>
             ...
             <a href="${pageContext.request.contextPath}/sortBy">SortBy:
				</a>&nbsp;|&nbsp;
		...
		<a href="Discount.jsp""${pageContext.request.contextPath}/discount">
			Discount </a><br> <br> <a href="Promo.jsp""${pageContext.request.contextPath}/promo">
			Promos </a>
