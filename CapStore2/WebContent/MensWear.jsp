...
<div class="header-container">
	...
	<br>
	<div align="center">
		<a href="""${pageContext.request.contextPath}/shirts">Shirts&T-shirts</a>
			 <br /> <a href="""${pageContext.request.contextPath}/jeans">Men's Jeans</a>
			 <br /> <a href="""${pageContext.request.contextPath}/bags"> Bags </a>
			  <br /> <a href="""${pageContext.request.contextPath}/watches">Mens Watches</a>
			 <br /> <a href="""${pageContext.request.contextPath}/perfumes">Perfumes</a>
